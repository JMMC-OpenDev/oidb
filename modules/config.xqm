...
(:~
 ...
 :)
declare variable $config:sql-driver-classname := "com.mysql.jdbc.Driver";
declare variable $config:sql-url := "jdbc:mysql://localhost:3306/testoidb";
declare variable $config:sql-username := "root";
declare variable $config:sql-password := "";

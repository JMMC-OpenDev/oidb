    ...
    $.fn.sampify = function(mtypes) {
        ...
        .bind('show.bs.dropdown', function (e) {
            ...
            connector.runWithConnection(function (conn) {
                ...
                conn.getSubscribedClients(["samp.app.ping"], function (res) {
                    
                    
                    
                    // redo query to help that ct.subs are better updated ...
                    conn.getSubscribedClients(["samp.app.ping"], function (res) {
                    
                        //console.log("runWithConnection: "+JSON.stringify(ct));
                        //console.log("getSubscribedClients: "+JSON.stringify(res));
                        //console.log("subs: "+JSON.stringify(ct.subs));
                        ct.calculateSubscriptions();
                        //console.log("getSubscribedClients: "+JSON.stringify(res));
                        //console.log("subs: "+JSON.stringify(ct.subs));
